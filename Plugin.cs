...
namespace Akula
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Akula";
        public static string heroName = characterName;

        public static string subclassName = "Shark"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Akula, the Shark.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Akula",
                _contentFolder: "Akula",
